        ...
        <div>
          ...
          <div style={{ color: 'var(--text-secondary)', fontSize: '1.125rem', marginBottom: '2rem' }}>
            ...
            <div style={{ marginTop: '1rem', display: 'flex', alignItems: 'center', gap: '0.75rem', flexWrap: 'wrap' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-primary)', fontSize: '1rem', background: 'var(--bg-surface)', padding: '0.75rem 1.25rem', borderRadius: '8px', border: '1px solid var(--glass-border)' }}>
